...
oOM.p    = oOM.p    + aOMp   * x0( 1, 1);
oOM.e    = oOM.e    + 0.0001 * x0( 2, 1);
oOM.peT  = oOM.peT  + 61     * x0( 6, 1);
oOM.lan  = oOM.lan  + aq     * x0( 3, 1);
oOM.incl = oOM.incl + aq     * x0( 4, 1);
oOM.aop  = oOM.aop  + aq     * x0( 5, 1);

oOK.p    = oOK.p    + aOKp   * x0( 7, 1);
oOK.e    = oOK.e    + 0.0001 * x0( 8, 1);
oOK.peT  = oOK.peT  + 61     * x0(12, 1);
oOK.lan  = oOK.lan  + aq     * x0( 9, 1);
oOK.incl = oOK.incl + aq     * x0(10, 1);
oOK.aop  = oOK.aop  + aq     * x0(11, 1);


thEM = -acos((oOM.p / SOIr_M - 1) / (oOM.e));

eT   =  argToTime(thEM, oOM.p, oOM.e, mu_M, oOM.peT);
[xxEM, vvEM] = paramsToPosVel(thEM, oOM.p, oOM.e, oOM.lan,  oOM.incl, oOM.aop, mu_M);

[thEK] = timeToArg(eT, oOK.p, oOK.e, mu_K, oOK.peT);
[xxEK, vvEK] = paramsToPosVel(thEK, oOK.p, oOK.e, oOK.lan, oOK.incl, oOK.aop, mu_K);

[thMK] = timeToArg(eT, oMK.p, oMK.e, mu_K, oMK.peT);
[xxMK, vvMK] = paramsToPosVel(thMK, oMK.p, oMK.e, oMK.lan, oMK.incl, oMK.aop, mu_K);

cc = [norm(xxEK - xxMK, 2) - SOIr_M; ...
      norm(((xxEK - xxMK) - xxEM), 2); ...
      norm(((vvEK - vvMK) - vvEM), 2)];

fprintf('%23.16e\n%23.16e\n%23.16e\n', cc(1, 1), cc(2, 1), cc(3, 1))

save Bashir_2_OrbitData.mat oOK oOM oMK eT thEM thEK thMK mu_K mu_M R_K R_M SOIr_M
